...
export default function Navigation({ className = "" }: NavigationProps) {
  ...
  const linkBaseClasses =
    "inline-flex items-center justify-center rounded-md px-4 py-2 min-h-[44px] min-w-[44px] text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-[#2563eb]/30 focus:ring-offset-2";
